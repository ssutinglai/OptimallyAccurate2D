...
# Load the data
m1 = genfromtxt("../../../Katayama/P1.txt");
a1 = -m1[:,1];
t1 = m1[:,0]-1.6e-6;
m2 = genfromtxt("../../../Katayama/P2.txt");
a2 = -m2[:,1];
t2 = m2[:,0]-1.6e-6;
m3 = genfromtxt("../../../Katayama/P3.txt");
a3 = -m3[:,1];
t3 = m3[:,0]-1.6e-6;
m4 = genfromtxt("../../../Katayama/P4.txt");
a4 = -m4[:,1];
t4 = m4[:,0]-1.6e-6;
m5 = genfromtxt("../../../Katayama/P5.txt");
a5 = -m5[:,1];
t5 = m5[:,0]-1.6e-6;
m6 = genfromtxt("../../../Katayama/P6.txt");
a6 = -m6[:,1];
t6 = m6[:,0]-1.6e-6;
m7 = genfromtxt("../../../Katayama/P7.txt");
a7 = -m7[:,1];
t7 = m7[:,0]-1.6e-6;
m8 = genfromtxt("../../../Katayama/P8.txt");
a8 = -m8[:,1];
t8 = m8[:,0]-1.6e-6;
m9 = genfromtxt("../../../Katayama/P9.txt");
a9 = -m9[:,1];
t9 = m9[:,0]-1.6e-6;
m10 = genfromtxt("../../../Katayama/P10.txt");
a10 = -m10[:,1];
t10 = m10[:,0]-1.6e-6;
m11 = genfromtxt("../../../Katayama/P11.txt");
a11 = -m11[:,1];
t11 = m11[:,0]-1.6e-6;
m12 = genfromtxt("../../../Katayama/P12.txt");
a12 = -m12[:,1];
t12 = m12[:,0]-1.6e-6;
m13 = genfromtxt("../../../Katayama/P13.txt");
a13 = -m13[:,1];
t13 = m13[:,0]-1.6e-6;
m14 = genfromtxt("../../../Katayama/P14.txt");
a14 = -m14[:,1];
t14 = m14[:,0]-1.6e-6;
m15 = genfromtxt("../../../Katayama/P15.txt");
a15 = -m15[:,1];
t15 = m15[:,0]-1.6e-6;
m16 = genfromtxt("../../../Katayama/P16.txt");
a16 = -m16[:,1];
t16 = m16[:,0]-1.6e-6;
m17 = genfromtxt("../../../Katayama/P17.txt");
a17 = -m17[:,1];
t17 = m17[:,0]-1.6e-6;
m18 = genfromtxt("../../../Katayama/P18.txt");
a18 = -m18[:,1];
t18 = m18[:,0]-1.6e-6;
m19 = genfromtxt("../../../Katayama/P19.txt");
a19 = -m19[:,1];
t19 = m19[:,0]-1.6e-6;
m20 = genfromtxt("../../../Katayama/P20.txt");
a20 = -m20[:,1];
t20 = m20[:,0]-1.6e-6;
