...
# Load the data
m1 = genfromtxt("1K_VP_5330_VS_3310/Receiver01P.txt");
a1 = -m1[:,1];
t1 = m1[:,0]-1.6e-6;
m2 = genfromtxt("2K_VP_5350_VS_3310/Receiver01P.txt");
a2 = -m2[:,1];
t2 = m2[:,0]-1.6e-6;
m3 = genfromtxt("3K_VP_5350_VS_3320/Receiver01P.txt");
a3 = -m3[:,1];
t3 = m3[:,0]-1.6e-6;
m4 = genfromtxt("4K_VP_5390_VS_3320/Receiver01P.txt");
a4 = -m4[:,1];
t4 = m4[:,0]-1.6e-6;
m5 = genfromtxt("5K_VP_5400_VS_3340/Receiver01P.txt");
a5 = -m5[:,1];
t5 = m5[:,0]-1.6e-6;
m6 = genfromtxt("6K_VP_5400_VS_3340/Receiver01P.txt");
a6 = -m6[:,1];
t6 = m6[:,0]-1.6e-6;
m7 = genfromtxt("7K_VP_5390_VS_3330/Receiver01P.txt");
a7 = -m7[:,1];
t7 = m7[:,0]-1.6e-6;
m8 = genfromtxt("8K_VP_5390_VS_3330/Receiver01P.txt");
a8 = -m8[:,1];
t8 = m8[:,0]-1.6e-6;
m9 = genfromtxt("9K_VP_5390_VS_3320/Receiver01P.txt");
a9 = -m9[:,1];
t9 = m9[:,0]-1.6e-6;
m10 = genfromtxt("10K_VP_5350_VS_3320/Receiver01P.txt");
a10 = -m10[:,1];
t10 = m10[:,0]-1.6e-6;
m11 = genfromtxt("11K_VP_5340_VS_3310/Receiver01P.txt");
a11 = -m11[:,1];
t11 = m11[:,0]-1.6e-6;
m12 = genfromtxt("12K_VP_5310_VS_3290/Receiver01P.txt");
a12 = -m12[:,1];
t12 = m12[:,0]-1.6e-6;
m13 = genfromtxt("13K_VP_5260_VS_3280/Receiver01P.txt");
a13 = -m13[:,1];
t13 = m13[:,0]-1.6e-6;
m14 = genfromtxt("14K_VP_5160_VS_3230/Receiver01P.txt");
a14 = -m14[:,1];
t14 = m14[:,0]-1.6e-6;
m15 = genfromtxt("15K_VP_5050_VS_3200/Receiver01P.txt");
a15 = -m15[:,1];
t15 = m15[:,0]-1.6e-6;
m16 = genfromtxt("16K_VP_4920_VS_3130/Receiver01P.txt");
a16 = -m16[:,1];
t16 = m16[:,0]-1.6e-6;
m17 = genfromtxt("17K_VP_4740_VS_3050/Receiver01P.txt");
a17 = -m17[:,1];
t17 = m17[:,0]-1.6e-6;
m18 = genfromtxt("18K_VP_4490_VS_2920/Receiver01P.txt");
a18 = -m18[:,1];
t18 = m18[:,0]-1.6e-6;
m19 = genfromtxt("19K_VP_4170_VS_2780/Receiver01P.txt");
a19 = -m19[:,1];
t19 = m19[:,0]-1.6e-6;
m20 = genfromtxt("20K_VP_3870_VS_2500/Receiver01P.txt");
a20 = -m20[:,1];
t20 = m20[:,0]-1.6e-6;
