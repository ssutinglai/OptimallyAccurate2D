...
!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%!
    ...
    do ix=2,nx
      ...
      do iz=2,nz
         ...
         if ((ix+1.eq.(centrenz+int(sqrt(dble(nradius**2-(centrenx-ix)**2))))).or. &
              (ix-1.eq.(centrenz-int(sqrt(dble(nradius**2-(centrenx-ix)**2)))))) then
       ...
       do iz=2,nz
          ...
          if((ix+1.le.(centrenx+int(sqrt(dble(nradius**2-(centrenz-iz)**2))))).and. &
             ...
             (iz-1.ge.(centrenz-int(sqrt(dble(nradius**2-(centrenx-ix)**2)))))) then
              ...
              ux(ix,iz) = ux(ix,iz) &
                            + ( &
                            - (           (   wwork1(iz-1,-1) + wwork1(iz-1,1) &
                            + wwork1(iz+1,-1) + wwork1(iz+1,1) ) &
                            + 10.d0 * (   wwork1(iz-1, 0) + wwork1(  iz,-1) &
                            + wwork1(  iz, 1) + wwork1(iz+1, 0) ) &
                            + 100.d0 * wwork1(ix,0) ) &
                            + e1(ix,iz) * wwork5(iz) &
                            - e2(ix,iz) * wwork5(iz+1) &
                            + e3(ix,iz) * wwork6(iz,0) &
                            - e4(ix,iz) * wwork6(iz,1) &
                            ) / 144.d0 &
                            + e13(ix,iz) * wwork11(iz-1) &
                            + e14(ix,iz) * wwork11(iz) &
                            + e15(ix,iz) * wwork11(iz+1) &
                            + e16(ix,iz) * wwork11(iz22) &
                            + e17(ix,iz) * wwork12(iz,-1) &
                            + e18(ix,iz) * wwork12(iz,0) &
                            + e19(ix,iz) * wwork12(iz,1) &
                            + e20(ix,iz) * wwork12(iz,2)
!
              uz(ix,iz) = uz(ix,iz) &
                            + ( &
