...
subroutine calstep_circle_free( nx,nz, &
  ...
  double precision wwork1(-2:1,nz+1),wwork2(-1:2,nz+1)
  double precision wwork3(-2:1,nz+1),wwork4(-1:2,nz+1)
  double precision wwork5(nz+1),wwork6(0:1,nz+1)
  double precision wwork7(nz+1),wwork8(0:1,nz+1)
  double precision wwork9(nz+1),wwork10(-2:1,nz+1)
  double precision wwork11(nz+1),wwork12(-1:2,nz+1)
...
!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%!
    ...
    do ix=2,nx
      ...
      do iz=2,nz
         ...
         if ((iz+1.eq.(centrenz+int(sqrt(dble(nradius**2-(centrenx-ix)**2))))).and. &
              !(ix-1.eq.(centrenx-int(sqrt(dble(nradius**2-(centrenz-iz)**2)))))) then !.and. &
        ...
        !iz2 = 3
            ...
            wwork1(-1,iz) = 0.d0
            wwork1(0,iz) = 0.d0
            wwork1(1,iz) = ux(ix1,iz) - 2.d0 * ux1(ix1,iz) + ux2(ix1,iz)
            wwork2(-1,iz) = 0.d0
            wwork2(0,iz) = 0.d0
            wwork2(1,iz) = uz(ix1,iz) - 2.d0 * uz1(ix1,iz) + uz2(ix1,iz)
            wwork2(2,iz) = uz(ix2,iz) - 2.d0 * uz1(ix2,iz) + uz2(ix2,iz)
            wwork3(-2,iz) = 0.d0
            wwork3(-1,iz) = 0.d0
            wwork3(0,iz) = 0.d0
            wwork3(1,iz) = wwork1(1,iz) + 12.d0 * ux1(ix1,iz)
            wwork4(-1,iz) = 0.d0
            wwork4(0,iz) = 0.d0
            wwork4(1,iz) = wwork2(1,iz) + 12.d0 * uz1(ix1,iz)
            wwork4(2,iz) = wwork2(2,iz) + 12.d0 * uz1(ix2,iz)
